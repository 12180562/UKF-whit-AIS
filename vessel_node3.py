...
class data_inNout:
    ...
    def __init__(self):
        ...
        self.WP_pub = rospy.Publisher('/vessel3_info', col, queue_size=10)
        self.cri_pub = rospy.Publisher('/cri3_info', cri_info, queue_size=10)
...
def main():  
    ...
    while not rospy.is_shutdown():
        ...
        if local_goal_EDA < 10 * (ship_L/OS_scale) :
